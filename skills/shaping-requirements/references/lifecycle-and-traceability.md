...
For mechanical metadata updates or archiving, use the shared Pi-native [change tool](../../closing-qb-change/references/change-tool.md). Tool errors require diagnosis rather than a shell or direct-edit bypass. Semantic edits and approval/evidence decisions remain with the agent.
